...
## Model setup
########################################
clf_gb_org = GradientBoostingClassifier(verbose=1)
clf_gb = GradientBoostingClassifier(n_estimators=30, learning_rate=0.1, max_depth=4, verbose=1)

########################################
## Model training
########################################
classifiers = [clf_gb_org, clf_gb]
...
param_grid = {'n_estimators': [10, 30], 'max_features':["sqrt", None], 'max_depth':[3,4]}
...
train_sizes, train_scores, val_scores = learning_curve(\
  estimator=GradientBoostingClassifier(n_estimators=ne, max_features=mf, max_depth=md), \
