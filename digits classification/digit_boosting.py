...
## Model setup
########################################
clf_gb_org = GradientBoostingClassifier(max_features="sqrt", verbose=1)
clf_gb = GradientBoostingClassifier(n_estimators=400, learning_rate=0.1, \
	max_features="sqrt", max_depth=3, verbose=1)
...
max_train_size = X_train.shape[0]
